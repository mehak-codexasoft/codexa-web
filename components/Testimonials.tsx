        ...
        >
          {testimonials.map((testimonial) => (
            <motion.div key={testimonial.name} variants={itemVariants}>
              <TiltCard className="h-full glass-card rounded-xl" tiltAmount={7}>
                <div className="p-8 relative group h-full">
                  {/* Quote Icon */}
                  ...
                  <div className="flex items-center gap-3">
                    <motion.div
                      ...
                      className={`w-11 h-11 rounded-full bg-gradient-to-br ${testimonial.color} flex items-center justify-center text-sm font-bold text-white shadow-lg`}
                    >
                      {testimonial.avatar}
                    </motion.div>
                    <div>
